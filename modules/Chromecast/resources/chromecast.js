(function ( mw, $ ) {
    ...
    mw.PluginManager.add( 'chromecast', mw.KBaseComponent.extend( {
        ...
        addBindings: function () {
            var _this = this;
            this.bind( 'chromecastPlay', function () {
                _this.playMedia();
            } );
            this.bind( 'chromecastPause', function () {
                _this.pauseMedia();
            } );
            this.bind( 'chromecastGetCurrentTime', function () {
                _this.getCurrentTime();
            } );
            this.bind( 'chromecastSetVolume', function ( e, percent ) {
                _this.setVolume( e, percent );
            } );
            this.bind( 'chromecastSeek', function ( e, percent ) {
                _this.seekMedia( percent );
            } );
            this.bind( 'stopCasting', function () {
                _this.toggleCast();
            } );
        ...
        onRequestSessionSuccess: function ( e ) {
            ...
            var mediaInfo = new this.chromeLib.cast.media.MediaInfo();
            this.request = new this.chromeLib.cast.media.LoadRequest( mediaInfo );
            this.request.customData = embedData ;

            this.session.loadMedia( this.request,
                this.onMediaDiscovered.bind( this, 'loadMedia' ), this.onMediaError );
...
//				}
            ...
            this.getComponent().css( "color", "#35BCDA" );
            this.updateTooltip( this.stopCastTitle );
            mediaSession.addUpdateListener( function ( e ) {
                _this.onMediaStatusUpdate( e );
            } );
